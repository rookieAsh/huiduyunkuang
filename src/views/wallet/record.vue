  ...
  <div class="recordPage">
    ...
    <div class="content">
      ...
      >
        ...
        <div class="itemLI text-right" v-if="item.status == 'success'">
          交易成功
        </div>
        <div class="itemLI text-right" v-if="item.status == 'pending'">
          审核中
        </div>
        <div class="itemLI text-right" v-if="item.status == 'fail'">
          交易失败
        </div>
      </div>
    </div>
