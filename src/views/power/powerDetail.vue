<template>
  <div class="powerPage">
    ...
    <el-dialog :visible.sync="AgreementVisible" class="agreementCon">
      <h1 class="title">
        矿机／算力租赁（购买）、委托管理服务协议（电子签约版）
      </h1>
      <div>
        <div class="title1">尊敬的用户朋友：</div>
        <div class="contents">
          <span>灰度云矿</span
          >（以下简称我们）致力于挖矿即服务的信条，使用最新技术提供多算法、多币种的云挖矿服务。通过将矿机／算力出售／租赁给客户，并同步提供矿机／算力委托管理和挖矿维护业务，为客户提供不同规模的加密数字货币挖矿能力的一站式解决方案。
        ...
        <div class="contents">
          ...
          但无论采用租赁方式还是购买的方式，用户均应同步委托灰度云矿对矿机进行委托管理，以便于实现用户算力的最大化，最大限度保障用户的权益；若用户以购买方式委托灰度云矿对矿机管理一年以上，用户有权在提前书面通知灰度云矿的情况下（一般为提前30日通
          知，以使得灰度云矿有充分的准备时间），解除矿机的委托管理服务，并自行安排运输将矿机提货至用户预先准备的地址。
        </div>
        <h2>二、矿机委托管理服务内容</h2>
        <div class="contents">
        ...
        <div class="contents">
          4.2
          若用户采取购买方式，且委托管理的矿机运行时长超过1年，则用户有权在第一个委托管理周期届满前提前30日书面通知灰度云矿，以解除灰度云矿的托管授权，灰度云矿可与用户协商在适当时间停止矿机的运行，并配合客户对矿机的运输工作。
          但灰度云矿自矿机交付用户指定的第一承运人时不再承担矿机的任何管理责任，尤其是矿机自身的安全责任和自身损坏赔偿责任及对任何第三方造成损害的赔偿责任。
        </div>
        <div class="contents">
          4.3
          若用户在协议“4.2条”的情况下，在委托管理期限届满后超过90还未提货的，则灰度云矿有权收取一定的保管费用。
        </div>
        <h2>五、服务终止条款： 满足以下条款之一，服务即自动终止。</h2>
        <div class="contents">
          5.1
          若挖矿收益不足以抵扣电费，灰度云矿将暂时关闭受影响的矿机，并按用户预留的
          联系方式通知用户充缴；若停机90天仍不满足开机条件，将下架矿机并联系用户处理，用户将获得60天处理期以充缴电费重新开机；若逾期或无法取得联系，将视为用户放弃矿机且服务自动终止。
        </div>
        <div class="contents">
          5.2
          由于发生不能预见、不能避免或不能克服的客观事件造成的损失，导致矿场无法继
          续运营时，服务将提前终止，灰度云矿不对此承担赔偿责任。
        </div>
        <div class="contents">
          5.3
          丰水期枯水期转换时将产生矿机转场期，转场期间不收取电费且不产生挖矿收入，
          每次转场期预计为15天，受不可控因素影响或适当延长。
        </div>
        <div class="contents">
          5.4
          丰水期或发生电力不稳定情况，将可能临时停机或算力下线，停机时不收取电费且
          不产生挖矿收入，损益累计月结。
        </div>
        <h2>六、费用负担</h2>
        <div class="contents">
          用户需要向灰度云矿支付的费用有年度矿机租赁费，矿机永久购买费用、委托管理费用和基础电费等；请注意，下单并支付成功后，订单将无法撤销和退款。
          特殊产品类别将在购买页面公示收费项目及方式，请仔细阅读购买页面产品详情。以充分理解费用负担。
        </div>
        <h2>七、用户和灰度云矿的权利义务关系</h2>
        <div class="contents">
          7.1用户需要知悉：灰度云矿并非一个矿机的销售商，用户如果采用购买矿机的方式，矿机的所有权通过占有改定的方式转移，但用户必须同时使用灰度云矿的委托管理服务一年以上才能够拥有矿机的占有和处分权能。
        </div>
        <div class="contents">
          7.2
        ...
        <h2>九、协议变更、解除、终止和权利义务的转让</h2>
        <div class="contents">9.1 协议变更</div>
        <div class="contents">
          灰度云矿保留根据市场的需要，不定期修改交易方式、托管时长等协议内容的权利，如果根据诚实信用原则是被认为合理的或必要的。
        </div>
        <div>9.2 协议解除与终止</div>
        <div class="contents">
          9.2.1
        ...
        <div class="contents">9.2.2 您的账户因任何原因注销的；</div>
        <div class="contents">
          9.2.3冒用他人名义、盗用他人账户使用平台服务的；
        </div>
        <div class="contents">9.2.4 为非法目的使用平台服务的；</div>
        <div class="contents">9.2.5从事任何可能侵害平台系统、资料之行为；</div>
        <div class="contents">9.2.6违反任何法律法规、本协议约定的；</div>
        <div class="contents">
